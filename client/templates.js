...
templatizer["pages"]["press"] = function tmpl_pages_press() {
    return '<section class="page press-page"><article class="page-inside press-page-inside"><h1>Press Page<div class="press-about"><div class="container"><div class="row"><div class="col-md-3 col-lg-2"><h2>Game Factsheet Hardcoded</h2><h2 data-hook="game-facts-title"></h2><div data-hook="game-facts"></div></div><div class="col-md-9 col-lg-10"><h2>Game Information Hardcoded</h2><div data-hook="game-info"></div></div></div></div></div><div data-hook="game-videos"></div><div data-hook="game-screenshots"></div><div data-hook="game-images"></div><div data-hook="game-awards"></div><div data-hook="game-mentions"></div><div data-hook="game-credits"></div></h1></article></section>';
};
...
// includes\game\game-fact.jade compiled template
templatizer["includes"]["game"]["game-fact"] = function tmpl_includes_game_game_fact() {
    return '<div class="game-facts"><div class="fact-wrapper"><div data-hook="fact-title" class="fact-title"></div><div data-hook="fact-data" class="fact-data"></div></div></div>';
};
